 ...
 *
 */
public class CostAccountRequest implements Serializable {
	 ...
	 */
	@NotNull
	private CostAccountRequestData requestData;
	 ...
	 *            the svPrId to set
	 */
	public CostAccountRequest setSvPrId(String svPrId) {
		this.svPrId = svPrId;
		return this;
	}
	 ...
	 */
	public CostAccountRequest setChannelId(String channelId) {
	 ...
	 */
	public CostAccountRequest setChannelSign(String channelSign) {
	 ...
	 */
	public CostAccountRequest setClearingDate(Date clearingDate) {
	 ...
	 */
	public CostAccountRequest setTxnSerialNo(String txnSerialNo) {
	 ...
	 */
	public CostAccountRequest setTimestamp(Date timestamp) {
	 ...
	 *            the asynInd to set
	 */
	public CostAccountRequest setAsynInd(AsynInd asynInd) {
	 ...
	 */
	public CostAccountRequestData getRequestData() {
		return requestData;
	}
	 ...
	 */
	public CostAccountRequest setRequestData(CostAccountRequestData requestData) {
