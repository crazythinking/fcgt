package net.engining.gateway.fts.sdk.bean.limit;
...
public class LimitRequest implements Serializable {
	 ...
	 */
	@NotNull
	private AccountLimitRequestData requestData;
	 ...
	 *            the svPrId to set
	 */
	public LimitRequest setSvPrId(String svPrId) {
		this.svPrId = svPrId;
		return this;
	}
	 ...
	 */
	public LimitRequest setChannelId(String channelId) {
	 ...
	 */
	public LimitRequest setChannelSign(String channelSign) {
	 ...
	 */
	public LimitRequest setClearingDate(Date clearingDate) {
	 ...
	 */
	public LimitRequest setTxnSerialNo(String txnSerialNo) {
	 ...
	 */
	public LimitRequest setTimestamp(Date timestamp) {
	 ...
	 *            the asynInd to set
	 */
	public LimitRequest setAsynInd(AsynInd asynInd) {
	 ...
	 */
	public AccountLimitRequestData getRequestData() {
		return requestData;
	}
	 ...
	 */
	public LimitRequest setRequestData(AccountLimitRequestData requestData) {
