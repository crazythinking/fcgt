...
public class RepaymentAccountBizCheck implements Invoker, Skippable {
	
	private static final Logger log = LoggerFactory.getLogger(RepaymentAccountBizCheck.class);
	...
	public void invoke(FlowContext ctx) {
		...
		RepaymentRequestData data = (RepaymentRequestData) JSONObject.toJavaObject(jsonObject,
				RepaymentRequestData.class);
		// 联合贷数据
		...
		requestData.setAccountTrading(AccountTradingDef.H);
		...
		// SAO
		String result = outerLedgerTxnHstSao.repaymentAccount(bean);
