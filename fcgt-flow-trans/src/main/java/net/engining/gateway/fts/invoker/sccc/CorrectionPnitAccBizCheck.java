...
public class CorrectionPnitAccBizCheck implements Invoker, Skippable {

	private static final Logger log = LoggerFactory.getLogger(CorrectionPnitAccBizCheck.class);
	...
	public void invoke(FlowContext ctx) {
		...
		CorrectionPnitAccRequestData data = (CorrectionPnitAccRequestData) JSONObject.toJavaObject(jsonObject,CorrectionPnitAccRequestData.class);
		...
		requestData.setAccountTrading(AccountTradingDef.C_PINTACC);
		...
		// SAO
		String result = accountingSao.correctionPnitAcc(bean);
