...
public class CorrectionInteAccBizCheck implements Invoker, Skippable {

	private static final Logger log = LoggerFactory.getLogger(CorrectionInteAccBizCheck.class);
	...
	public void invoke(FlowContext ctx) {
		...
		CorrectionInteAccRequestData data = (CorrectionInteAccRequestData) JSONObject.toJavaObject(jsonObject,CorrectionInteAccRequestData.class);
		...
		requestData.setAccountTrading(AccountTradingDef.C_INTEACC);
		...
		// SAO
		String result = accountingSao.correctionInteAcc(bean);
