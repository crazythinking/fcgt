...
public class LoanAccountBizCheck implements Invoker, Skippable {
	
	private static final Logger log = LoggerFactory.getLogger(LoanAccountBizCheck.class);
	...
	public void invoke(FlowContext ctx) {
		...
		LoanAccountRequestData data = (LoanAccountRequestData) JSONObject.toJavaObject(jsonObject,LoanAccountRequestData.class);
		...
		requestData.setAccountTrading(AccountTradingDef.D);
		...
		//SAO
		String result = outerLedgerTxnHstSao.loanAccount(bean);
