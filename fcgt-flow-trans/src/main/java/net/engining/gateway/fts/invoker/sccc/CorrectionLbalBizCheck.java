...
public class CorrectionLbalBizCheck implements Invoker, Skippable {

	private static final Logger log = LoggerFactory.getLogger(CorrectionLbalBizCheck.class);
	...
	public void invoke(FlowContext ctx) {
		...
		CorrectionTransfoRequestData data = (CorrectionTransfoRequestData) JSONObject.toJavaObject(jsonObject,CorrectionTransfoRequestData.class);
		...
		requestData.setAccountTrading(AccountTradingDef.C_LBAL);
