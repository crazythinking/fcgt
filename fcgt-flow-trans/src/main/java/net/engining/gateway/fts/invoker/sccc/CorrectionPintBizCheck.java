...
public class CorrectionPintBizCheck implements Invoker, Skippable {

	private static final Logger log = LoggerFactory.getLogger(CorrectionPintBizCheck.class);
	...
	public void invoke(FlowContext ctx) {
		...
		CorrectionPintRequestData data = (CorrectionPintRequestData) JSONObject.toJavaObject(jsonObject,CorrectionPintRequestData.class);
		...
		requestData.setAccountTrading(AccountTradingDef.C_PINT);
