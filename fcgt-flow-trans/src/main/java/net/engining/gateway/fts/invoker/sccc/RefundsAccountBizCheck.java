...
public class RefundsAccountBizCheck implements Invoker, Skippable {
	
	private static final Logger log = LoggerFactory.getLogger(RefundsAccountBizCheck.class);
	...
	public void invoke(FlowContext ctx) {
		...
		RefundsRequestData data = (RefundsRequestData) JSONObject.toJavaObject(jsonObject, RefundsRequestData.class);
		...
		requestData.setAccountTrading(AccountTradingDef.T);
		...
		// SAO
		String result = outerLedgerTxnHstSao.refundsAccount(bean);
